...
function articleMaker(element){
  ...
  articleP1.textContent = element.firstParagraph;
  articleP2.textContent = element.secondParagraph;
  articleP3.textContent = element.thirdParagraph;
  ...
  articleBox.appendChild(expandButton);
